...
export const lifePath: LifePath[] = [
  { n: 1, title: "Начало", line: "Умение начинать и вести за собой", detail: "" },
  { n: 2, title: "Согласие", line: "Чуткость к другим и способность договариваться", detail: "" },
  { n: 3, title: "Выражение", line: "Лёгкость слова и умение находить точную формулировку", detail: "" },
  { n: 4, title: "Опора", line: "Порядок и терпение в долгой работе", detail: "" },
  { n: 5, title: "Перемена", line: "Тяга к новому и способность быстро перестраиваться", detail: "" },
  { n: 6, title: "Забота", line: "Ответственность за близкий круг и умение держать дом", detail: "" },
  { n: 7, title: "Понимание", line: "Потребность разбираться в устройстве вещей", detail: "" },
  { n: 8, title: "Масштаб", line: "Способность управлять ресурсами и держать большое", detail: "" },
  { n: 9, title: "Широта", line: "Дальний взгляд и умение отпускать", detail: "" },
  { n: 11, title: "Чувствование", line: "Обострённая чуткость к тому, что не проговаривают", detail: "" },
  {
    n: 22,
    title: "Воплощение",
